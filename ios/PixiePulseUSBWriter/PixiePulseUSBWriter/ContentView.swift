        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    PulseDotSetupPanel(model: model) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                HStack(alignment: .top) {
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        Text("Push inbox and PulseDot writer")
                            .font(.subheadline)
        ...
        Panel {
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 3) {
                    ...
                    Text("SidePulse will store general pushes here even without a PulseDot device.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
...
private struct PulseDotSetupPanel: View {
    @ObservedObject var model: AppModel
    let openSetup: () -> Void
        ...
        Panel {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Button {
                    ...
                    Label(model.hasFolderAccess ? "Change LED Folder" : "Set Up PulseDot Folder", systemImage: "folder.badge.plus")
                        .frame(maxWidth: .infinity)
                }
    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .leading, spacing: 18) {
                Label("PulseDot Device in Files", systemImage: "externaldrive")
                    .font(.title3.weight(.semibold))

                VStack(alignment: .leading, spacing: 10) {
                    Text("1. Attach the PulseDot USB drive to this iPhone or iPad.")
                    Text("2. Open Files and select the PulseDot USB drive folder containing LEDS.TXT.")
