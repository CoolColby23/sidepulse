...
def main() -> int:
    ...
    parser.add_argument("--server", default=os.environ.get("SIDE_SERVER_URL", "http://127.0.0.1:8787"))
    parser.add_argument("--secret", default=os.environ.get("SIDE_SHARED_SECRET"))
    parser.add_argument("--device-token", default=os.environ.get("SIDE_DEVICE_TOKEN") or os.environ.get("PIXIE_DEVICE_TOKEN"))
    parser.add_argument("--pattern", default="green_pulse_2")
    parser.add_argument("--leds", help="Inline LEDS.TXT text. If set, this wins over pattern in the app.")
    parser.add_argument("--file", type=Path, help="Path to a LEDS.TXT file.")
