"""Antigravity hook adapter for the SidePulse agent monitor.

Antigravity uses camelCase payloads and requires event-specific JSON responses
on stdout. SidePulse stores a provider-neutral event while preserving that
contract, so this hook observes activity without changing permission policy.
"""
