...
SD_EJECT_GUARD_BINARY_NAME = "sd_eject_guard"
...
def install_sd_eject_guard(
    *,
    ...
    return SdEjectGuardResult(
        ...
        changed=plist_changed or compiled or cleanup_removed is not None or (dry_run and needs_compile),
        compiled=compiled,
...
def packaged_sd_eject_guard_source():
    return files("agent_monitor.resources").joinpath("sd_eject_guard.c")
