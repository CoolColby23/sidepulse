// sd_eject_guard - veto software ejects of cards in the built-in SD reader.
//
...
//
// Build: clang -o sd_eject_guard sd_eject_guard.c \
...
static DADissenterRef eject_approval(DADiskRef disk, void *ctx) {
    ...
    return DADissenterCreate(kCFAllocatorDefault, kDAReturnNotPermitted,
                             CFSTR("sd_eject_guard: keeping SD card attached"));
}
...
int main(int argc, char **argv) {
    ...
    printf("sd_eject_guard: watching for ejects of the built-in SD reader%s...\n",
